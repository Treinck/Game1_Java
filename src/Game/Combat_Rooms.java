...
public class Combat_Rooms {
	...
	static void combat_room(int rooms_visited,int total_dmg, int crit_dmg, int player_hp, int pot,boolean  shield, String name ) { 
