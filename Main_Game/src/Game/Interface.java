...
public class Interface {
	static void InterfaceP1(int player_hp, int total_dmg, int pot, int rooms_visited, int food, boolean shield, boolean sword, String name) {
		...
		System.out.println("|Você tem " + food + " porções de comida         |");
		System.out.println("|                                     |");
		if (rooms_visited > 9) {
